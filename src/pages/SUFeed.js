              ...
              <header className="flex items-center space-x-4">
                ...
                <div className="">
                  <div className="flex items-center space-x-1">
                    <p className=" font-semibold">Students Union</p>
                    <p className="">:</p>
                    <p className=" text-gray-500">1d</p>
                  </div>
                  <div className="text-sm text-gray-500">Be the Change</div>
                </div>
              </header>
              <p className="mt-4">
                Our UG (Regular) 1997 batch alumni & UG (Sandwich) 1998 batch
                alumni donated Rs 40 lakhs to PSG Tech Alumni Foundation as part
                of the Silver Jubilee Celebrations of our college, PSG College
                Of Technology .
              </p>
            </div>
